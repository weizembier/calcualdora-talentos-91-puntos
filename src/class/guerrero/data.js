...
talent[i] = [0, "Improved Intercept", 2, 1, 6]; i++;
...
talent[i] = [1, "Weapon Mastery", 2, 3, 5]; i++;
...
talent[i] = [2, "Desarmar", 2, 2, 4]; i++;
talent[i] = [2, "Endender Armadura", 3, 3, 4]; i++;
...
//Bloodsurge - Fury
rank[i] = [
"Your Bloodthirst critical hits have a 33% chance of making your next Slam instant for 5 sec.",
"Your Bloodthirst critical hits have a 66% chance of making your next Slam instant for 5 sec.",
