...
talent[i] = [2, "Trap Mastery", 1, 2, 9]; i++;
talent[i] = [2, "Sniper Training", 3, 4, 9]; i++;
talent[i] = [2, "Hunting Party", 5, 3, 10, [getTalentID("Thrill of the Hunt"),3]]; i++;
talent[i] = [2, "Explosive Shot", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;
...
rank[i] = [
"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>When activated, this ability immediately finishes the cooldown of your other Hunter abilities."
		];
i++;		
...
rank[i]=[
"You have a 33% chance when you trap a target and a 2% chance when you deal periodic damage with your Serpent Sing to cause your next 2 Arcane Shot or Explosive Shot spells to trigger no cooldown, cost no mana and consume no ammo.",
"You have a 66% chance when you trap a target and a 4% chance when you deal periodic damage with your Serpent Sing to cause your next 2 Arcane Shot or Explosive Shot spells to trigger no cooldown, cost no mana and consume no ammo.",
"You have a 100% chance when you trap a target and a 6% chance when you deal periodic damage with your Serpent Sing to cause your next 2 Arcane Shot or Explosive Shot spells to trigger no cooldown, cost no mana and consume no ammo."
		];
i++;	
...
rank[i]=[
"Frost Trap and Freezing Trap - Increases the duration by 30%.<br/><br/>Immolation and Explosive Trap - Increases the damage done by 30%.<br/><br/>Snake Trap - Increases the number of snakes summoned by 30%."
		];
i++;	
...
rank[i] = [
		"<span style=text-align:left;float:left;>7% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant Cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Requires Ranged Weapon<br>You fire an explosive charge into the enemy target, dealing 121-139 Fire damage. The charge will blast the target every second for an additional 2 sec. Each charge also deals 30-35 Fire damage to all nearby enemies within 5 yards of the target."
		];
i++;	
