...
talent[i] = [0, "Lightning Overload", 5, 3, 8]; i++;
talent[i] = [0, "Astral Shift", 3, 1, 9]; i++;
talent[i] = [0, "Totem of Wrath", 1, 2, 9]; i++;
talent[i] = [0, "Lava Flows", 3, 3, 9]; i++;
talent[i] = [0, "Storm, Earth and Fire", 5, 2, 10]; i++;
talent[i] = [0, "Thunderstorm", 1, 2, 11, [getTalentID("Storm, Earth and Fire"),5]]; i++;
...
rank[i] = [
"Increases the range of your Lightning Bolt, Chain Lightning and Lava Burst spells by 3 yards, and increases the radius of your Thunderstorm spell by 10%.",
"Increases the range of your Lightning Bolt, Chain Lightning and Lava Burst spells by 6 yards, and increases the radius of your Thunderstorm spell by 20%."
		];
i++;	
...
"When you gain a critical effect from your Healing Wave, Lesser Healing Wave or Riptide spells, you have a 66% chance to instantly consume a Water Shield Orb.",
"When you gain a critical effect from your Healing Wave, Lesser Healing Wave or Riptide spells, you have a 100% chance to instantly consume a Water Shield Orb."
		];
i++;		
