...
massiveReplaceString += '<div id="classInformation"><span id="resetAll"><a href="" onclick="resetTreeAll();return false;"><img src="/talentcalcs/wotlk/includes/images/en/resetall.gif" border="0"></a></span><span id="classNameOverall"><span id="className"></span><span id="spec">(<span id="spec0" class="mySmallWhite">0</span>/<span id="spec1" class="mySmallWhite">0</span>/<span id="spec2" class="mySmallWhite">0</span>)</span></span><span id="PointsAvailOverall"><span id="PointsLeftText">Puntos Restantes:</span><span id="tabPointsAvailable" class="mySmallWhite">51</span></span><span id="requiredLevelOverall"><span id="requiredLevelText">Nivel Requerido: </span><span id="levelRequired" class="mySmallWhite">9</span></span></div>';
...
for (var printTreeID = 0; printTreeID < numberOfTrees; printTreeID++) {
	...
	massiveReplaceString += '<td  style = "background: url(\'' + imgPath +'/'+ nlclass +'/images/'+ imgDir + treeName +'/background.jpg\') #000000 no-repeat; background-size: 100% 100%;">';	
			...
			for (verticalCounter = 1; verticalCounter <= vertical; verticalCounter++)
			{
				...
				for (horizontalCounter = 1; horizontalCounter <= horizontal; horizontalCounter++)
				{
					...
					if (talent[i] && talent[i][3] == horizontalCounter && talent[i][4] == verticalCounter)
					{
						...
						massiveReplaceString += '<div style = "z-index: 99999; position: relative;"><div style = "top: -2px; left: -2px; position: absolute;"><img src = "'+ pixelGif +'" width = "50px" height = "50px" border = "0" onClick = "rankTopOnClick('+ i +');" onMouseOver = "unhideTalent('+ i +');" onMouseOut = "hideTalent('+ i +');" onContextMenu = "rankTopOnRightClick('+ i +'); return false;" /></div></div>';
